...
CCOPTS=-O3 -Wall -Werror -D_FILE_OFFSET_BITS=64 -D_REENTRANT -DGC_THREADS
LINKOPTS=-lgc

SRCNOGEN=9pstatic.c 9p.c
SRCNOINC=main.c
SRCINC=list.c vector.c hashtable.c connection.c handles.c transaction.c fid.c util.c config.c transport.c storage.c object.c envoy.c remote.c dispatch.c worker.c heap.c lru.c oid.c dir.c claim.c lease.c walk.c
INCNOSRC=types.h
